...
class StoryList {
  ...
  static async getStories() {
    ...
    //  instance method?
      // because then getStories will only be called when a new StoryList class is made in that instance, when we need to get the stories from the API and use them within the class.
